...
app.post("/register", (req, res) => {
  ...
  const sql =
    "INSERT INTO customer (cu_email, cu_name, cu_phone, password) VALUES (?, ?, ?, ?)";
...
// get all vehicles
app.get("/vehiclesClass", (req, res) => {
    var sql = "SELECT * FROM v_class";
...
app.post("/vehicles", (req, res) => {
  ...
  var sql =
    "INSERT INTO vehicle (vin, make, model, year, plate, class_id) VALUES (?, ?, ?, ?, ?, ?)";
...
app.get("/rentals", (req, res) => {
  var sql =
    "SELECT * FROM rental r, customer c WHERE r.customer_id = c.customer_id";
...
app.post("/rentals", (req, res) => {
  ...
  var sql =
    "INSERT INTO rental (pick_date, drop_date, start_odo, end_odo, pick_loc, drop_loc, customer_id, vin) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
  var params = [
    pick_date,
    drop_date,
    start_odo,
...
// Route to handle POST request for searching payment by coupon_id
app.post("/couponBy", (req, res) => {
